...
function ColorPallet() {
    ...
    $("ul.pattern .color1").click(function () {
        return $("#option-color").attr("href", "../colors/green.css")
    });
    $("ul.pattern .color2").click(function () {
        return $("#option-color").attr("href", "../colors/yellow.css")
    });
    $("ul.pattern .color3").click(function () {
        return $("#option-color").attr("href", "../colors/golden.css")
    });
    $("ul.pattern .color4").click(function () {
        return $("#option-color").attr("href", "../colors/sky-blue.css")
    });
    $("ul.pattern .color5").click(function () {
        return $("#option-color").attr("href", "../colors/blue.css")
    });
    $("ul.pattern .color6").click(function () {
        return $("#option-color").attr("href", "../colors/purple.css")
    });
    $("ul.pattern .color7").click(function () {
        return $("#option-color").attr("href", "../colors/orange.css")
    });
    $("ul.pattern .color8").click(function () {
        return $("#option-color").attr("href", "../colors/pink.css")
    });
    $("ul.pattern .color9").click(function () {
        return $("#option-color").attr("href", "../colors/red.css")
    });
